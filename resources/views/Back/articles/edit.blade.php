            ...
            <form action="{{ route('back.articles.update', $article->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="titre" id="titre" class="form-control" value="{{ old('titre', $article->titre) }}">
                        @if ($errors->has('titre'))
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <textarea name="contenu" id="contenu" class="form-control">{{ old('contenu', $article->contenu) }}</textarea>
