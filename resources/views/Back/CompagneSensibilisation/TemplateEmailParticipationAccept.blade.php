    ...
    <tbody>
      <tr style="vertical-align: top">
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                        ...
                        <tbody>
                          <tr>
                            <td
                              ...
                              <div
                                style="font-size: 14px; color: #e2a560; line-height: 170%; text-align: center; word-wrap: break-word;">
                              </div>
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                   ...
                                   src="https://i.imghippo.com/files/DAXUN1727497211.png"                                      alt="Image" title="Image"
                                      style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 50%;max-width: 280px;"
                                      width="280" />
          ...
          <div class="u-row-container" style="padding: 0px;background-color: transparent">
            <div class="u-row"
              style="margin: 0 auto;min-width: 320px;max-width:600px; border-radius:10px; overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #f06112;">
              <div
                style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
                <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 0px;background-color: transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;"><tr style="background-color: #f06112;"><![endif]-->
                            ...
                            <td
                              ...
                              <div
                                ...
                                <p style="line-height: 140%;"><span
                                    style="font-size: 24px; line-height: 33.6px;">Campaign Participation Accepted!</span></p>
                              </div>
                              ...
                              <div
                                ...
                                <p style="font-size: 14px; line-height: 160%;">
                                  ...
                                  <span
                                    ...
                                    style="background-color: #f06112; border-radius: 20px; padding: 5px; color: white;  font-weight: bold;">
                                    {{ $data['name'] }}
                                  </span>

                                        <p>We are excited to inform you that your request to participate in the <strong>{{ $data['campaign_name'] }}</strong> campaign has been successfully accepted!</p>

                                        <p>Thank you for showing interest in our campaign. Your participation is valuable and we look forward to working with you to make this campaign a great success.</p>

                                        <h4>Campaign Details:</h4>
                                            <p><strong>Campaign Name:</strong> {{ $data['campaign_name'] }}</p>
                                            <p><strong>Start Date:</strong> {{ $data['campaign_startDate'] }}</p>
                                            <p><strong>Participation Date:</strong> {{ $data['participation_date'] }}</p>

                                        <p>If you have any questions or need more information, feel free to reply to this email or contact our support team.</p>

                                        <p>Best regards,<br>The {{ $data['campaign_name'] }} Team</p>
          ...
          <div class="u-row-container" style="padding: 0px;background-color: transparent">
            <div class="u-row"
              style="margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #e2a560;">
              <div
                style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
                <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 0px;background-color: transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;"><tr style="background-color: #d1d1e3;"><![endif]-->
                                      ...
                                      <tr style="vertical-align: top">
                                        <td align="left" valign="middle"
                                          ...
                                          <a href="https://email.com/" title="Email" target="_blank">
                                            <img src="https://cdn.tools.unlayer.com/social/icons/circle-white/email.png"
          ...
          <div class="u-row-container" style="padding: 0px;background-color: transparent">
            <div class="u-row"
              style="margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #f06112;">
              <div
                style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
                <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 0px;background-color: transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;"><tr style="background-color: #f06112;"><![endif]-->
                            ...
                            <td
                              ...
                              <div
                                ...
                                <p style="font-size: 14px; line-height: 180%;"><span
                                    style="font-size: 16px; line-height: 28.8px;">Copyrights © 2024 EcoImpact - Innovators
